...
//    final static String TOKEN = "4d01e07fa8905f5b3a3e819da5491564";
//
//    class UrlResponse {
//        @SerializedName("Code")
//        private int code;
...
//    }
    ...
    public static String getShortURL(String longUrl) throws IOException {
        URL u = new URL("http://lnurl.cn/tcn-api.json?key=hd3j2ryt&url=" + longUrl);
    ...
    public static void main(String[] args) throws IOException {
        String shortURL = getShortURL("http://myo2o.yitiaojieinfo.com/myo2o/frontend/index");
