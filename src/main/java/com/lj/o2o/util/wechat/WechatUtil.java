package com.lj.o2o.util.wechat;
...
public class WechatUtil {
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wxc09f29ff1697ba33";
        log.debug("appId:" + appId);
        // 测试号信息里的appsecret
        String appsecret = "3b55023b2b746fe9f84f9f9b206ccfe3";
     ...
     * @return
     */
    public static PersonInfo getPersonInfoRequest(WechatUser user) {
