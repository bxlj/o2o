...
import com.lj.o2o.dto.WechatUser;
 ...
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc09f29ff1697ba33&redirect_uri=http://bxljsucc.top/o2o/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=2#wechat_redirect
 * 则这里将会获取到code,之后再可以通过code获取到access	_token 进而获取到用户信息
 * 
 * @author 贾
 *
 */
public class WechatLoginController {
	...
	public String doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		if (auth == null) {
			...
			if (WechatAuthStateEnum.SUCCESS.getState() != we.getState()) {
				return null;
			} else {
